...
class AsistenciaEncargadoController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('EncargadoProyecto.listadoAsistencia')->with('asistencias', $asistencias);}
        else{
            return route('login');
        }
    }
    ...
    {
        $empleados= User::all();
        return view('EncargadoProyecto.createAsistencia')->with('empleados', $empleados);
    }
    ...
    public function store(AsistenciaRequest $request)
    {
        ...
        return redirect('encargado/Asistencia');
    ...
    public function show($id)
    {
        ...
        return view('EncargadoProyecto.detallesAsistencia')->with('asistencia', $asistencia);
    }
    ...
    public function edit($id)
    {
        ...
        return view('EncargadoProyecto.edit')->with('asistencia',$asistencia);
    }
    ...
    public function update(AsistenciaRequest $request, $id)
    {
        ...
        return redirect('encargado/Asistencia')->with('Actualizado', 'La asistencia ha sido actualizada :)');
    }

                                                            ...
                                                            <th class="small-12 large-12 columns first last">
                                                                <table>
                                                                    <tr>
                                                                        <th>
                                                                            <center data-parsed="">
                                                                                <a href="{{url('login')}}" align="center" class="text-center">
                                                                                    <img src="https://i.ibb.co/VgXRDqH/Logotipo.png" class="swu-logo">
                                                                                </a>
                                                                            </center>
                                                                        </th>
                                                                        <th class="expander"></th>
                                                        ...
                                                        <table class="row masthead"><tbody><tr> <!-- Masthead -->
                                                                    <th class="small-12 large-12 columns first last">
                                                                        <table>
                                                                            <tr>
                                                                                <th>
                                                                                    <h1 class="text-center">Bienvenido a ARKITASK!!</h1>
                                                                                    <center data-parsed="">
                                                                                        <img src="https://i.ibb.co/bzhTzCp/Recurso-1.png" valign="bottom" align="center" class="text-center">
                                                                                    </center>
                                                                                    ...
                                                                                    <th class="small-12 large-12 columns first last">
                                                                                        <table>
                                                                                            <tr>
                                                                                                <th>
                                                                                                    <b><h5>¡Hola!</h5></b>
                                                                                                    <p>¡Has sido registrado en la plataforma ARKITASK!
                                                                                                        <br>
                                                                                                        Es hora de comenzar a navegar 🚀.
                                                                                                        Para ingresar utiliza el mismo correo donde te llego este mensaje
                                                                                                        <br>
                                                                                                        Tenemos que <strong> asignarte una nueva contraseña 🧐 </strong>, vamos a ello
                                                                                                        </p>
                                                                                                    ...
                                                                                                    <div class="button">
                                                                                                        <!--[if mso]>
                                                                                                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:35px;v-text-anchor:middle;width:150px;" arcsize="8%" strokecolor="#f7931d" fillcolor="#f7931d">
                                                                                                              <w:anchorlock/>
                                                                                                              <center style="color:#ffffff;font-family:sans-serif;font-size:16px;font-weight:bold;">Vamos!!</center>
                                                                                                            </v:roundrect>
                                                                                                        <![endif]-->
                                                                                                        <a href="{{url('asignarcontra/'. $idUsuario)}}" style="background-color:#f7931d;border:0px solid #f7931d;border-radius:3px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:16px;font-weight:bold;line-height:35px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;mso-hide:all;">Vamos!!</a>
                                                                                                    </div>
                                                                                                </th>
                                                                                                <th class="expander"></th>
                                                                                            </tr>
                                                            ...
                                                            <table class="row grey"><tbody><tr>
                                                                        <th class="small-12 large-12 columns first last">
                                                                            <table>
                                                                                <tr>
                                                                                    <th>
                                                                                        <p class="text-center footercopy">&#xA9; Copyright 2021 Arkitask. All Rights Reserved.</p>
                                                                                    </th>
                                                                                    <th class="expander"></th>
                                                                                </tr>
                                                                            </table>

                                                                            ...
                                                                            <table class="row"><tbody><tr> <!-- main Email content -->
                                                                                        <th class="small-12 large-12 columns first last">
                                                                                            <table>
                                                                                                <tr>
                                                                                                    <th>
                                                                                                        <b><h5>Hola {{$usuario->Nombre}} {{$usuario->Apellido}}</h5></b>
                                                                                                        <p>¡Has sido registrado en la plataforma ARKITASK!
                                                                                                            <br>
                                                                                                            Es hora de comenzar a navegar 🚀. Tu usuario es tu correo {{$usuario->email}}
                                                                                                            <br>
                                                                                                            Tenemos que asignarte una contraseña, vamos a ellos
                                                                                                            </p>
